...
namespace Arvin_AITest
{
    public partial class TaxiFarePrediction
    {
        public const string RetrainFilePath =  @"D:\Arvin\Arvin.Lib\Arvin.AITest\Data\taxi-fare-train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=8,NumberOfTrees=44,MaximumBinCountPerFeature=1023,FeatureFraction=0.99999999,LearningRate=0.999999776672986,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features"}));
